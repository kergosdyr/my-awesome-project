...
[구현 파일](../../coding/src/main/java/challenge/coding/FirstUnique.java) · [공개 테스트](../../coding/src/test/java/challenge/coding/FirstUniqueTest.java)
...
입력: null이 아닌 영문 소문자 a~z 문자열, 길이 0~100,000. 출력: 조건을 만족하는 최소 인덱스, 없으면 -1. 입력 변경 없음. 예1:
...
```sh
./gradlew :coding:test --tests '*FirstUniqueTest'
```
