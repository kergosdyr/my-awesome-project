...
구현: [MaintenanceWindows.java](../../src/main/java/challenge/coding/MaintenanceWindows.java) · [공개 테스트](../../src/test/java/challenge/coding/MaintenanceWindowsTest.java)
...
./gradlew test --tests challenge.coding.MaintenanceWindowsTest
./gradlew test --tests challenge.coding.MaintenanceWindowsTest -Pminimum
```

IntelliJ에서 `maintenance-windows - Coding`, `maintenance-windows - Coding Minimum`, `maintenance-windows - All`을 사용한다.
All은 현재 C004만 실행한다. 다음 Backend는 [Day 5 독립 결제 실습](payment-recovery.md)이다.
