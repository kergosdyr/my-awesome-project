...
| --- | --- | --- |
| C002 | [LongestMonitoringSpan.java](../../src/main/java/challenge/coding/LongestMonitoringSpan.java) | reservation-cancellation - Coding |
| B002 | [CancellationService.java](../../legacy/main/java/challenge/reservation/cancellation/CancellationService.java), 필요한 Repository | reservation-cancellation - Backend |
| 전체 | 공개 테스트 전체 | reservation-cancellation - All |
| Minimum | 같은 파일, 범위 축소 | reservation-cancellation - Coding Minimum / reservation-cancellation - Backend Minimum |

```sh
cd /Users/justin/IdeaProjects/my-project/study/challenge-120
./gradlew test --tests challenge.coding.LongestMonitoringSpanTest --rerun-tasks
./gradlew legacyTest --tests challenge.reservation.cancellation.CancellationServiceTest --rerun-tasks
