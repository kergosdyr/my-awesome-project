...
[구현 파일](../../coding/src/main/java/challenge/coding/NextHigher.java) · [공개 테스트](../../coding/src/test/java/challenge/coding/NextHigherTest.java)
...
```sh
./gradlew :coding:test --tests '*NextHigherTest'
```
