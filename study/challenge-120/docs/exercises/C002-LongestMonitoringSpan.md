# C002 — 허용 지연 안의 최장 관측 구간

[구현 파일](../../coding/src/main/java/challenge/coding/LongestMonitoringSpan.java) · [공개 테스트](../../coding/src/test/java/challenge/coding/LongestMonitoringSpanTest.java)
...
실행: ./gradlew :coding:test --tests '*LongestMonitoringSpanTest'
IntelliJ 구성: C002 - LongestMonitoringSpan

```sh
./gradlew :coding:test --tests '*LongestMonitoringSpanTest'
```
