...
[구현 파일](../../coding/src/main/java/challenge/coding/SizeSearch.java) · [공개 테스트](../../coding/src/test/java/challenge/coding/SizeSearchTest.java)
...
실행: ./gradlew :coding:test --tests '*SizeSearchTest'
IntelliJ 구성: C007 - SizeSearch

```sh
./gradlew :coding:test --tests '*SizeSearchTest'
```
