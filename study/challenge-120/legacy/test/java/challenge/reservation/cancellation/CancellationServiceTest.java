...
import static challenge.reservation.cancellation.CancellationService.Result.*;
...
class CancellationServiceTest {
    ...
    @BeforeEach void setup() {
        ...
        new ResourceDatabasePopulator(new ClassPathResource("reservation/reservation-cancellation/schema.sql")).execute(jdbc.getDataSource());
