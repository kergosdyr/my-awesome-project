...
import static challenge.reservation.basic.ReservationResult.Status.*;
...
class ReservationServiceTest {
    ...
    @BeforeEach void setup() {
        ...
        new ResourceDatabasePopulator(new ClassPathResource("reservation/reservation-basics/schema.sql")).execute(jdbc.getDataSource());
